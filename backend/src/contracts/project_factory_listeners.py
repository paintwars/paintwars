...
from src.models.paintwars.project.project_crud import PROJECTS, ProjectCreate
from src.models.paintwars.project_event.project_event_crud import (
    PROJECT_EVENTS,
    ProjectEventCreate,
)
...
from src.models.paintwars.action.action_crud import ACTIONS
