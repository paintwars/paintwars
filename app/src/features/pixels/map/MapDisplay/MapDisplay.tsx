...
import ScenarioActionPanel, { type ActionItem } from "./ScenarioActionPanel";
import {
	ScenarioActionsProvider,
	useScenarioActions,
} from "./ScenarioActionsContext";
...
const MapDisplay: React.FC<Props> = () => {
	...
	// Scenario actions state (now from context)
